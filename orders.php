                            ...
                            <div class="white_card_body ">
                                ...
                                <div class="QA_table ">
                                    ...
                                    <table class="table lms_table_active2 p-0">
                                        ...
                                        {
                                            $search = $_POST['search'];
                                            $sql = mysqli_query($db, "SELECT * FROM `orders` WHERE email = '$search' OR orderid = '$search' ORDER BY id DESC");
                                        }
                                        else
                                        {
                                        ...
                                        while ($row = mysqli_fetch_array($sql))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="f_s_12 f_w_400 text-end">
                                                    <a href="viewOrder.php?view=<?php echo $row['orderid']; ?>" class="action_btn">
                                                        <?php
