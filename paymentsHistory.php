                                            ...
                                            <div class="col-lg-8 d-flex justify-content-end">
                                                <div class="serach_field-area theme_bg d-flex align-items-center">
                                                    <div class="search_inner">
                                                        <form action="paymentsHistory.php" enctype="multipart/form-data" method="post">
                            ...
                            <div class="white_card_body ">
                                ...
                                <div class="QA_table ">
                                    ...
                                    <table class="table lms_table_active2 p-0">
                                        ...
                                        {
                                            $search = $_POST['search'];
                                            $sql = mysqli_query($db, "SELECT * FROM `credits` WHERE invoice_no = '$search' AND email = '".$_SESSION['email']."' ORDER BY id DESC");
                                        }
                                        else
                                        {
                                            $sql = mysqli_query($db, "SELECT * FROM `credits` WHERE email = '".$_SESSION['email']."' ORDER by id DESC");
                                        }
